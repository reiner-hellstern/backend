-- Gebührenordnung 2024 Import (UPDATE Version)
-- Stand: 31.10.2024, Gültig ab: 01.04.2024

-- 1. Gebührenordnung aktualisieren (falls bereits vorhanden)
...
-- 2. Gebührengruppen hinzufügen/aktualisieren
...
-- 3. Gebührenkatalog hinzufügen/aktualisieren
...
(25, 3, 'Bringleistungsprüfung (BLP) mit Zusatzfächern', 'BLP mit Zusatzfächer', NOW(), NOW()),
...
ON DUPLICATE KEY UPDATE 
gebuehrengruppe_id = VALUES(gebuehrengruppe_id),
name = VALUES(name),
beschreibung = VALUES(beschreibung),
updated_at = NOW();

-- 4. Gebühren hinzufügen/aktualisieren (mit aktuellen Preisen von 2024)
...
ON DUPLICATE KEY UPDATE 
gebuehrenkatalog_id = VALUES(gebuehrenkatalog_id),
gebuehrenordnung_id = VALUES(gebuehrenordnung_id),
stand = VALUES(stand),
gueltig_ab = VALUES(gueltig_ab),
gueltig_bis = VALUES(gueltig_bis),
kosten_mitglied = VALUES(kosten_mitglied),
kosten_nichtmitglied = VALUES(kosten_nichtmitglied),
aktiv = VALUES(aktiv),
updated_at = NOW();

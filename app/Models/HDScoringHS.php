...
class HDScoringHS extends Model
{
    use HasFactory;

    protected $table = 'hd_scorings_hs';
    ...
    {
        return $this->belongsTo(OptionHDScoringHS::class, 'hd_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringHS::class, 'hd_l_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringHS::class, 'hd_r_id');
    }

...
class HDScoringFCI extends Model
{
    use HasFactory;

    protected $table = 'hd_scorings_fci';
    ...
    {
        return $this->belongsTo(OptionHDScoringFCI::class, 'hd_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringFCI::class, 'hd_l_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringFCI::class, 'hd_r_id');
    }

...
class HDScoringDRC extends Model
{
    use HasFactory;

    protected $table = 'hd_scorings_drc';
    ...
    {
        return $this->belongsTo(OptionHDScoringDRC::class, 'hd_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringDRC::class, 'hd_l_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringDRC::class, 'hd_r_id');
    }

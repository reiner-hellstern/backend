...
class GelenkuntersuchungEDVerifizierung extends Model
{
    use HasFactory;

    protected $table = 'gelenkuntersuchung_ed_verifizierungen';
    ...
    public function gelenkuntersuchung()
    {
        return $this->morphOne(Gelenkuntersuchung::class, 'gelenkuntersuchungable')->orderBy('updated_at', 'asc');
    }

    public function roentgenarzt()
    {
        return $this->belongsTo(Arzt::class, 'roentgenarzt_id');
    }

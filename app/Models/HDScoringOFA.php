...
class HDScoringOFA extends Model
{
    use HasFactory;

    protected $table = 'hd_scorings_ofa';
    ...
    {
        return $this->belongsTo(OptionHDScoringOFA::class, 'hd_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringOFA::class, 'hd_l_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringOFA::class, 'hd_r_id');
    }

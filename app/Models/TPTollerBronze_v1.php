...
class TPTollerBronze_v1 extends Model
{
    use HasFactory;

    protected $table = 'tptoller_bronze_v1';
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Leistungsziffer::class, 'anschleichen_id');
    }
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Leistungsziffer::class, 'tolling_id');
    }
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Leistungsziffer::class, 'wasserfreude_id');
    }
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Leistungsziffer::class, 'bringen_ente_id');
    }
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Leistungsziffer::class, 'zusammenarbeit_id');
    }
    ...
    {
        return $this->belongsTo(OptionTPTollerBronze1Schussfestigkeit::class, 'schussfestigkeit_id');
    }

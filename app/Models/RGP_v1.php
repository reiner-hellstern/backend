...
class RGP_v1 extends Model
{
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_riemenarbeit_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_totverbellen_id');
    }

    public function getWaldarbeitTotverbellenAttribute()
    {
        return $this->waldarbeit_totverbellen_id ? ['name' => $this->waldarbeit_totverbellen_option->name, 'id' => $this->waldarbeit_totverbellen_id, 'wert' => $this->waldarbeit_totverbellen_option->wert] : ['name' => 'Bitte auswählen', 'id' => 0];
    }

    public function waldarbeit_totverweisen_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_totverweisen_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_schleppe_hasekanin_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_suche_bringen_nutzwild_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_bringen_id');
    }

    public function getWaldarbeitBringenAttribute()
    {
        return $this->waldarbeit_bringen_id ? ['name' => $this->waldarbeit_bringen_option->name, 'id' => $this->waldarbeit_bringen_id, 'wert' => $this->waldarbeit_bringen_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function waldarbeit_buschieren_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_buschieren_id');
    }

    public function getWaldarbeitBuschierenAttribute()
    {
        return $this->waldarbeit_buschieren_id ? ['name' => $this->waldarbeit_buschieren_option->name, 'id' => $this->waldarbeit_buschieren_id, 'wert' => $this->waldarbeit_buschieren_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function waldarbeit_fuchsschleppe_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_fuchsschleppe_id');
    }

    public function getWaldarbeitFuchsschleppeAttribute()
    {
        return $this->waldarbeit_fuchsschleppe_id ? ['name' => $this->waldarbeit_fuchsschleppe_option->name, 'id' => $this->waldarbeit_fuchsschleppe_id, 'wert' => $this->waldarbeit_fuchsschleppe_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function waldarbeit_bringen_fuchsschleppe_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'waldarbeit_bringen_fuchsschleppe_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_stoebern_ohne_ente_id');
    }

    public function getWasserarbeitStoebernOhneEnteAttribute()
    {
        return $this->wasserarbeit_stoebern_ohne_ente_id ? ['name' => $this->wasserarbeit_stoebern_ohne_ente_option->name, 'id' => $this->wasserarbeit_stoebern_ohne_ente_id, 'wert' => $this->wasserarbeit_stoebern_ohne_ente_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function wasserarbeit_verlorensuche_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_verlorensuche_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_stoebern_mit_ente_id');
    }

    public function getWasserarbeitStoebernMitEnteAttribute()
    {
        return $this->wasserarbeit_stoebern_mit_ente_id ? ['name' => $this->wasserarbeit_stoebern_mit_ente_option->name, 'id' => $this->wasserarbeit_stoebern_mit_ente_id, 'wert' => $this->wasserarbeit_stoebern_mit_ente_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_id');
    }

    public function getWasserarbeitStoebernMitEnteZeugnisBewertungAttribute()
    {
        return $this->wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_id ? ['name' => $this->wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_option->name, 'id' => $this->wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_id, 'wert' => $this->wasserarbeit_stoebern_mit_ente_zeugnis_bewertung_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function wasserarbeit_markieren_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_markieren_id');
    }

    public function getWasserarbeitMarkierenAttribute()
    {
        return $this->wasserarbeit_markieren_id ? ['name' => $this->wasserarbeit_markieren_option->name, 'id' => $this->wasserarbeit_markieren_id, 'wert' => $this->wasserarbeit_markieren_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0];
    }

    public function wasserarbeit_bringen_ente_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'wasserarbeit_bringen_ente_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'feldarbeit_federwildschleppe_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'feldarbeit_einweisen_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'feldarbeit_merken_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'feldarbeit_standruhe_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'feldarbeit_bringen_federwild_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'gehorsam_allgemein_id');
    }

    public function getGehorsamAllgemeinAttribute()
    {
        return $this->gehorsam_allgemein_id ? ['name' => $this->gehorsam_allgemein_option->name, 'id' => $this->gehorsam_allgemein_id, 'wert' => $this->gehorsam_allgemein_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function gehorsam_stand_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'gehorsam_stand_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'gehorsam_leinenfuehrigkeit_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'gehorsam_folgen_id');
    }

    public function getGehorsamFolgenAttribute()
    {
        return $this->gehorsam_folgen_id ? ['name' => $this->gehorsam_folgen_option->name, 'id' => $this->gehorsam_folgen_id, 'wert' => $this->gehorsam_folgen_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function gehorsam_ablegen_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'gehorsam_ablegen_id');
    }

    public function getGehorsamAblegenAttribute()
    {
        return $this->gehorsam_ablegen_id ? ['name' => $this->gehorsam_ablegen_option->name, 'id' => $this->gehorsam_ablegen_id, 'wert' => $this->gehorsam_ablegen_option->wert] : ['wert' => 0, 'name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function arbeitsfreude_option()
    {
        return $this->belongsTo(OptionRGP1Leistungsziffer::class, 'arbeitsfreude_id');
    }

    public function getArbeitsfreudeAttribute()
    {
        return $this->arbeitsfreude_id ? ['name' => $this->arbeitsfreude_option->name, 'id' => $this->arbeitsfreude_id, 'wert' => $this->arbeitsfreude_option->wert] : ['name' => 'Bitte auswählen', 'id' => 0, 'wert' => 0];
    }

    public function schussfestigkeit_land_option()
    {
        return $this->belongsTo(OptionRGP1Schussfestigkeit::class, 'schussfestigkeit_land_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Schussfestigkeit::class, 'schussfestigkeit_wasser_id');
    }
    ...
    {
        return $this->belongsTo(OptionRGP1Preisklassen::class, 'preis_id');
    }

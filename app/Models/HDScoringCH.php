...
class HDScoringCH extends Model
{
    use HasFactory;

    protected $table = 'hd_scorings_ch';
    ...
    {
        return $this->belongsTo(OptionHDScoringCH::class, 'hd_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringCH::class, 'hd_l_id');
    }
    ...
    {
        return $this->belongsTo(OptionHDScoringCH::class, 'hd_r_id');
    }

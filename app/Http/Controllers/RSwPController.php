...
use App\Models\RSwP_v1;
use App\Models\VeranstaltungMeldung;
use Illuminate\Http\Request;

class RSwPController extends Controller
{
    /**
    ...
    public function store_v1(Request $request)
    {
        ...
        if ($meldung->resultable_id) {
            $ergebnis = RSwP_v1::find($meldung->resultable_id);
        } else {
            $ergebnis = new RSwP_v1();
            ...
            $meldung->resultable_type = 'App\Models\RSwP_v1';
            $meldung->save();
        }
        if ($request->ergebnis) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(RSwP_v1 $rSwP)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, RSwP_v1 $rSwP)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(RSwP_v1 $rSwP)
    {
        //
    }
}

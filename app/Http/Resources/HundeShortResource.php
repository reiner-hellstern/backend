...
class HundeShortResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $hund = [
            ...
            'orgatree' => $this->orgatree,
            'tod' => $this->tod,
            'seit' => $this->seit,
            'bis' => $this->bis,
            'zuchtzulassung' => $this->zuchtzulassung,
            // 'zuchtzulassung_datum' => $this->zuchtzulassung_datum,
        ...
        $hund['chipnummer'] = count($this->chipnummern) ? ($this->chipnummern)[0]->chipnummer : '';
        $hund['zuchtbuchnummer'] = count($this->zuchtbuchnummern) ? $this->zuchtbuchnummern[0]->zuchtbuchnummer : '';
        ...
        // PRUEFUNGEN
        $hund['pruefungstitel'] = PruefungenTitelResource::collection($this->pruefungen); // $this->pruefungen; //
        $hund['pruefungen'] = [];

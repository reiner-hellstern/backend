...
class StoreDokumentenkategorieRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:dokumentenkategorien,name'],
            'beschreibung' => ['nullable', 'string', 'max:65535'],
